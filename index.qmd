...
min_monthly = min(monthly.values()) if monthly else 0
...
for short, full in zip(months_short, months_full):
    ...
    # Scale from 20% to 100% for better visual differentiation
    height = 20 + ((count - min_monthly) / (max_monthly - min_monthly) * 80) if max_monthly > min_monthly else 50
    is_peak = full == peak_month
    monthly_html += f'''<div class="bar-col {"peak-col" if is_peak else ""}">
        <div class="bar-value">{count}</div>
        <div class="bar {"peak" if is_peak else ""}" style="height: {height}%;"></div>
        <span>{short}</span>
    </div>'''
    ...
    <div class="carousel">
        ...
        <div class="slide" data-slide="8">
            <div class="slide-content">
                ...
                <div class="binge-show-featured">{biggest_binge_show}</div>
                <div class="binge-stat">
                    <span class="binge-number">{biggest_binge}</span> episodes in one sitting
                </div>
